...
export default function SniperCourseDashboard({ studentName = "Trader" }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-yellow-900 text-white font-sans px-4 py-8 flex flex-col items-center">
      <div className="w-full max-w-2xl mx-auto">
        {/* Welcome */}
        <h1 className="text-2xl md:text-3xl font-bold mb-2 text-gold-500">Welcome back, {studentName} — Let’s begin your sniper trading journey.</h1>
          <div className={`bg-gradient-to-r from-yellow-400 to-yellow-600 h-4 rounded-full transition-all duration-500 progress-bar`} data-progress={progress}></div>
        <div className="w-full bg-gray-800 rounded-full h-4 mb-8 mt-2">
          <div
            className={`bg-gradient-to-r from-yellow-400 to-yellow-600 h-4 rounded-full transition-all duration-500 ${styles.progressFill}`}
